...
<body>
    ...
    ?>
    <div>
        <h2 class="centered-header">S&M Hotel Rooms</h2>
    </div>
    <div class="main">
        <?php
        ...
        $total_query = "SELECT COUNT(*) as count FROM Room";
        ...
        while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
            ...
            echo "<tr> 
                    ...
                    <td>$status</td>
                    <td class='actions'>
                        <a href='update_room.php?id=$room_id'>Update</a>
                        <a href='delete_room.php?id=$room_id'>Delete</a>
                    </td>
                </tr>";
        }
        echo "</table>";
